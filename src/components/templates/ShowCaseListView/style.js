...
export const useStyles = makeStyles((theme) => ({
  ...
  cardInHorizontal_content_pricing: {
    ...
    "@media (max-width: 620px)": {
      ...
      margin: "0 auto",
      borderRight: "0px solid #8E8E8E",
    },
  },
  cardInHorizontal_typo: {
    fontSize: "16px",
  },
  cardInHorizontal_time_sec: {
    // float: "right",
    flexDirection: "row",
    justifyContent: "flex-end",
    display: "flex",
  ...
  cardInHorizontal_content_profit: {
    borderRight: "1px solid #8E8E8E",
    width: "18%",
    display: "flex",
    flexDirection: "column",
  ...
  cardInHorizontal_content_action: {
    width: "auto",
    margin: "0 auto",
    display: "flex",
    flexDirection: "column",
